...
public class AttackSpeed extends Statistic {
	...
	public AttackSpeed(Player player, Attribute attribute) {
		this(player, attribute, 0, 0, BASE_EXP_LEVEL_UP, BASE);
	}
	
	public AttackSpeed(Player player, Attribute attribute, int experience, int level) {
		this.player = player;
	...
	public AttackSpeed(Player player, Attribute attribute, int experience, int level, int expToLevel, double value) {
		this.player = player;
		this.attribute = attribute;
