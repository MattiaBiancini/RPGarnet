...
public class Knockback extends Statistic {
	...
	public Knockback(Player player, Attribute attribute) {
		this(player, attribute, 0, 0, BASE_EXP_LEVEL_UP, BASE);
	}
	
	public Knockback(Player player, Attribute attribute, int experience, int level) {
		this.player = player;
	...
	public Knockback(Player player, Attribute attribute, int experience, int level, int expToLevel, double value) {
		this.player = player;
		this.attribute = attribute;
